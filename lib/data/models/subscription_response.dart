...
class PremiumPlan {
  ...
  factory PremiumPlan.fromJson(Map<String, dynamic> json) {
    ...
    return PremiumPlan(
      ...
      studentDiscountPercent: (json['studentDiscountPercent'] as num).toInt(),
      studentPrice: (json['studentPrice'] as num).toInt(),
      features: parseFeatures(json['features']),
      isActive: json['isActive'] as bool,
      currentSubscribers: (json['currentSubscribers'] as num).toInt(),
